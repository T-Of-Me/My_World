...
public class HttpConfiguration {
    ...
    @ManagedAttribute(value="The idle timeout in ms for I/O operations during the handling of a HTTP request")
    ...
    @ManagedAttribute(value="Total timeout in ms for blocking I/O operations.")
    ...
    public boolean isCookieCompliance(CookieCompliance compliance) {
        return this._cookieCompliance.equals((Object)compliance);
    }
