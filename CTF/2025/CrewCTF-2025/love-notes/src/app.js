...
// script-src : chỉ cho phép thực thi ở dashborad.js và hcaptcha
// style-src : chỉ cho phép load css từ static
// img-src : không cho phép load ảnh từ bất kỳ đâu
// connect-src : chỉ cho phép kết nối đến chính server này
// media-src, object-src, prefetch-src : không cho phép tải các loại tài nguyên này từ bất kỳ đâu
// frame-ancestors : không cho phép trang web này được nhúng trong iframe của bất kỳ trang nào khác
// form-action : chỉ cho phép gửi biểu mẫu trở lại chính server này
// frame-src : không cho phép nhúng bất kỳ khung nào từ bất kỳ đâu
